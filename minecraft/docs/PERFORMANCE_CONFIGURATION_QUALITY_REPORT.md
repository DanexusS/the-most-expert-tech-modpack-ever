...
| Measured optimization quests | `20/20` | PASS |

## Script inventory

- KubeJS JavaScript files: **201**
- Event subscriptions found: **193**
- Explicit console calls found: **22**
- Required measured optimization quests: **20**
