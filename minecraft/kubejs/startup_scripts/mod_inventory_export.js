// Optional runtime inventory for correlating the CurseForge manifest with
// actual loaded mod IDs. Normal launches must not perform this diagnostic file
// write. Enable it only for an evidence run with:
//   -Dexpert.modInventoryExport=true

var InventorySystem = Java.loadClass('java.lang.System')
var INVENTORY_EXPORT_ENABLED = String(
  InventorySystem.getProperty('expert.modInventoryExport', 'false')
).toLowerCase() === 'true'

if (INVENTORY_EXPORT_ENABLED) {
