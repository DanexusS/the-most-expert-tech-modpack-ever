ServerEvents.generateData('after_mods', event => {
  event.json('allthemodium:worldgen/placed_feature/allthemodium_mining.json', {
    "feature": "allthemodium:allthemodium_ore",
    "placement": [
      {
        "count": 6, 
  ...
  let addMiningDimOre = (path, id, min, max, size, count, stoneReplaces, deepslateReplaces, endStoneReplaces, netherrackReplaces) => {
    ...
    event.json(`allthemodium:worldgen/placed_feature/${path}.json`, jsonPlaced)
    event.json(`allthemodium:worldgen/configured_feature/${path}.json`, jsonConfigured)
    event.json(`allthemodium:neoforge/biome_modifier/allthemodium/dim_ores/${path}.json`, jsonForge)
  }
